  ...
  return (
    <div className='bg-accentDark mt-16'>
        <div className="container py-8 flex flex-col md:flex-row justify-between items-center gap-4 text-white">
           ...
           <div>
            <h3 className='text-xl sm:text-2xl font-semibold'>Sign up To Our Newsletter</h3>
           ...
           <div className="w-full max-w-[500px] relative">
               ...
               <button className='bg-accentDark absolute top-2 right-2 py-2 px-4 rounded-full hover:bg-accent'>
                Subscribe!
               </button>
